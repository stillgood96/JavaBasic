...
public class SamKwangCODP_VO {
    ...
    // 기본생성자  , codp 해당변수생성자 , 세번재 생성자 유심이 볼것
    public SamKwangCODP_VO() {
    }

    // codp 해당변수 생성자
    public SamKwangCODP_VO(int 고객번호, String 고객이름, int 주문번호, String 주문일, int 제품번호, int 수량, String 제품이름, int 단가) {
        this.고객번호 = 고객번호;
        this.고객이름 = 고객이름;
        this.주문번호 = 주문번호;
        this.주문일 = 주문일;
    ...
    public SamKwangCODP_VO(int 제품번호, int 주문번호, int 고객번호,  String 고객이름, String 주소, String 시도, String 우편번호, String 전화번호, String 주문일, String 납기일, String 인사번호, int 수량, String 제품이름, String 제품분류, int 단가, int 재고량) {
        this(고객번호,고객이름,주문번호,주문일,제품번호,수량,제품이름,단가);  //이거
    ...
    public String get인사번호() {
        return 인사번호;
    }

    public void set인사번호(String 인사번호) {
        this.인사번호 = 인사번호;
    }
