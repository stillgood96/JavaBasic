...
// src/main/java/javax/sevlet => Servlet.java
// src/main/java/javax/sevlet => GenericServlet.java
// src/main/java/javax/sevlet/http => HttpServlet.
// java
public class Interface2 {
    public static void main(String[] args) {
        Cat4 ct4=new Cat4();
        Dog4 do4=new Dog4();
        System.out.println(ct4.cry());
        System.out.println(do4.cry());
    }
...
interface Animal4action {
 ...
 abstract class Animal4Base extends Animal4  //기본클래스를 이용해 기본메서드를 줌
 ...
 class Dog4 extends Animal4Base{ //cry메서드를 다시 정의해야한다면 불러와서 재정의 하면된다.
     @Override
     public String cry() { return "머어어엉머어어엉"; }
 }
